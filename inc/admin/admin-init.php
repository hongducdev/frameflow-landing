...
/**
 * The Frameflow_Admin initiate the theme admin
 */
...
class Frameflow_Admin extends Frameflow_Base
{
	...
	public function fix_parent_menu()
	{
		...
		$submenu['pxlart'][0][0] = frameflow()->get_name() . ' ' . esc_html__('Dashboard', 'frameflow');

                        ...
                        [
                            ...
                            'controls' => [
                                frameflow_widget_select_control(
                                    ...
                                    [
                                        'logo_image' => esc_html__('Logo Image', 'frameflow'),
                                        'logo_icon' => esc_html__('Logo Icon', 'frameflow'),
                                    ],
                                    ['default' => 'logo_image'],
                                ),
                                ...
                                [
                                    ...
                                    'label' => esc_html__('Logo Height', 'frameflow'),
                                    'type' => \Elementor\Controls_Manager::SLIDER,
                                    'size_units' => ['px'],
                                    'range' => [
                                        'px' => [
                ...
                [
                    ...
                    'controls' => [
                        ...
                        frameflow_widget_color_control(
                            'gradient_color_1',
                            esc_html__('Gradient Color 1', 'frameflow'),
                            [
                                '{{WRAPPER}} .pxl-client-marquee' =>
                                    '--gradient-color-1: {{VALUE}};',
                            ],
                        ),
                        frameflow_widget_color_control(
                            'gradient_color_2',
                            esc_html__('Gradient Color 2', 'frameflow'),
                            [
                                '{{WRAPPER}} .pxl-client-marquee' =>
                                    '--gradient-color-2: {{VALUE}};',
                            ],
                        ),
                        [
                            'name' => 'size_gradient',
                            'label' => esc_html__('Gradient Size', 'frameflow'),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'size_units' => ['%'],
                            'range' => [
                                '%' => [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .pxl-client-marquee' =>
                                    '--size-gradient: {{SIZE}}{{UNIT}};',
                            ],
                        ],
                        [
                            'name' => 'size_item',
                            'label' => esc_html__('Item Size', 'frameflow'),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'size_units' => ['px'],
                            'range' => [
                                'px' => [
                ...
                [
                    ...
                    'controls' => [
                        frameflow_widget_color_control(
                            ...
                            [
                                '{{WRAPPER}} .pxl-client-marquee .pxl-item--inner' =>
                        ...
                        frameflow_widget_color_control(
                            ...
                            [
                                '{{WRAPPER}} .pxl-client-marquee .pxl-item:hover .pxl-item--inner' =>
                                    'background-color: {{VALUE}};',
                            ],
                        ),
                        ...
                        frameflow_widget_color_control(
                            ...
                            [
                                '{{WRAPPER}} .pxl-client-marquee .pxl-item--name' =>
                                    'color: {{VALUE}};',
                                '{{WRAPPER}} .pxl-client-marquee.style-2 .pxl-item--inner' =>
                                    'color: {{VALUE}};',
                            ],
                        ),
                        frameflow_widget_color_control(
                            'item_text_color_hover',
                            esc_html__('Item Text Hover', 'frameflow'),
                            [
                                '{{WRAPPER}} .pxl-client-marquee .pxl-item:hover .pxl-item--name' =>
                                    'color: {{VALUE}};',
                                '{{WRAPPER}} .pxl-client-marquee.style-2 .pxl-item:hover .pxl-item--inner' =>
                                    'color: {{VALUE}};',
                            ],
                        ),
                    ],

...
pxl_add_custom_widget(
    [
        ...
        "title" => esc_html__("Case Testimonial Grid", "frameflow"),
                    ...
                    "controls" => array_merge(
                        [
                            [
                                ...
                                "selectors" => [
                                    "{{WRAPPER}} .pxl-testimonial-grid" => "--pxl-grid-gap: {{SIZE}}{{UNIT}};",
                                ],
                            ],
                            ...
                            frameflow_widget_text_control(
                                ...
                                [
                                    "default" => "0",
                                    "description" => esc_html__(
                                        "Base delay (ms) before item animation. Each next item adds 100ms.",
                                        "frameflow",
                                    ),
                                ],
                            ),
                ...
                [
                    ...
                    "controls" => [
                        frameflow_widget_color_control(
                            ...
                            [
                                "{{WRAPPER}} .pxl-testimonial-grid .pxl-item" =>
                        ...
                        frameflow_widget_slider_control(
                            ...
                            [
                                "{{WRAPPER}} .pxl-testimonial-grid .pxl-item--inner" =>
                                    "gap: {{SIZE}}{{UNIT}};",
                            ],
                        ),
                    ],
                ...
                [
                    ...
                    "controls" => [
                        frameflow_widget_color_control(
                            ...
                            [
                                "{{WRAPPER}} .pxl-testimonial-grid .pxl-item--name" =>
                ...
                [
                    ...
                    "controls" => [
                        frameflow_widget_color_control(
                            ...
                            esc_html__("Color", "frameflow"),
                            [
                                "{{WRAPPER}} .pxl-testimonial-grid .pxl-item--position" =>
                                    "color: {{VALUE}} !important;",
                            ],
                        ),
                        frameflow_widget_typography_control(
                ...
                [
                    ...
                    "controls" => [
                        frameflow_widget_color_control(
                            ...
                            esc_html__("Color", "frameflow"),
                            [
                                "{{WRAPPER}} .pxl-testimonial-grid .pxl-item--description" =>
                                    "color: {{VALUE}} !important;",
                            ],
                        ),
                        frameflow_widget_typography_control(

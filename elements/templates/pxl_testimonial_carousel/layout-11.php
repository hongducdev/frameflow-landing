...
if (
    ...
    <div class="pxl-swiper-slider pxl-testimonial-carousel pxl-testimonial-carousel11" <?php if (
        $drap !== false
                    ...
                    <?php foreach ($settings['testimonial'] as $key => $value):
                        ...
                        <div class="pxl-swiper-slide">
                            <div class="pxl-item--inner <?php echo esc_attr(
                                ...
                                <div class="pxl-item--info-wrapper">
                                    ...
                                    <div class="pxl-item--info">
                                        ...
                                        <p class="pxl-item--position"><?php echo pxl_print_html(
                                            $position,
                                        ); ?></p>
                                        <?php if (!empty($star)): ?>
                                                ...
                                                <?php for ($i = 0; $i < $star; $i++): ?>
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                                                        <g clip-path="url(#clip0_2547_453)">
                                                            <path d="M14 5.4091L8.913 5.07466L6.99721 0.261719L5.08143 5.07466L0 5.4091L3.89741 8.7184L2.61849 13.7384L6.99721 10.9707L11.376 13.7384L10.097 8.7184L14 5.4091Z" fill="white"/>
                                                        </g>
                                                        <defs>

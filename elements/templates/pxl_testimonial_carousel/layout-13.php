...
if (
    ...
    ?>
    <div class="pxl-swiper-slider pxl-testimonial-carousel pxl-testimonial-carousel13" <?php if (
        $drap !== false
            ...
            <div <?php pxl_print_html($widget->get_render_attribute_string('carousel')); ?>>
                <div class="pxl-swiper-wrapper">
                    <?php foreach ($settings['testimonial'] as $value):
                        ...
                        $star = isset($value['star']) ? (int) $value['star'] : 0;
                        ?>
                                    ...
                                    <div class="pxl-item--star">
                                        <?php for ($i = 0; $i < $star; $i++): ?>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">
                                                <path d="M8 0L9.854 5.71L16 6.18L11.4 10.09L12.708 16L8 12.71L3.292 16L4.6 10.09L0 6.18L6.146 5.71L8 0Z" fill="currentColor"/>
                                            </svg>
                                        <?php endfor; ?>
                                    </div>
                                <?php endif; ?>

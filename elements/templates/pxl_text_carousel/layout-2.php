...
if (!empty($text_items)) : ?>
    <div class="pxl-swiper-slider pxl-text-carousel pxl-text-carousel2" <?php if ($drap !== false) : ?>data-cursor-drap="<?php echo esc_attr__('DRAG', 'frameflow'); ?>"<?php endif; ?>>
                    ...
                    ?>
                        <div class="pxl-swiper-slide">
                            <div class="pxl-item--inner <?php echo esc_attr($settings['pxl_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">
                                <?php if(!empty($settings['layout_2_icon']['value'])): ?>
                                    <div class="pxl-item--icon">
                                        <?php \Elementor\Icons_Manager::render_icon($settings['layout_2_icon'], ['aria-hidden' => 'true']); ?>
                                    </div>
                                <?php endif; ?>

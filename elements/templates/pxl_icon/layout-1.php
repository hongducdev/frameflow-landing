        ...
        <?php foreach ($settings['icons'] as $key => $value):
            ...
            <?php if (! empty($value['pxl_icon'])) : ?>
                <a class="elementor-repeater-item-<?php echo esc_attr($value['_id']); ?> <?php echo esc_attr($label_position); ?>" <?php echo implode(' ', [$link_attributes]); ?>>
                    ...
                    <?php endif; ?>
                    <?php if ($settings['style'] == 'style-box-outline'): ?>
                        <span class="icon-box-outline"></span>
                        <span class="icon-box-outline-2"></span>
                        <span class="icon-box-outline-3"></span>
                        <span class="icon-box-outline-4"></span>
                    <?php endif; ?>
                </a>
            <?php endif; ?>
        <?php endforeach; ?>

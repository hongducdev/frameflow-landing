<?php
/**
 * Case Icon Box Carousel – Layout 1
...
if (!empty($icon_boxes)) :
?>
<div class="pxl-swiper-slider pxl-icon-box-carousel pxl-icon-box-carousel1" <?php echo esc_attr($drap ? 'data-cursor-drap="' . esc_attr__('DRAG', 'frameflow') . '"' : ''); ?>>

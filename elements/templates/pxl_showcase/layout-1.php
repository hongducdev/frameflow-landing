...
?>
<div class="pxl-showcase pxl-showcase1  <?php if ($settings['active'] == 'yes') {
                                            echo 'pxl-wg-active';
                                        } ?>">
                    ...
                    <?php if ($settings['hot'] == 'true' || $settings['new'] == 'true') : ?>
                        <div class="showcase-status">
                            <?php if ($settings['hot'] == 'true') : ?>
                                <span class="hot"><?php echo esc_html__('Hot', 'frameflow'); ?></span>
                            <?php endif; ?>
                            <?php if ($settings['new'] == 'true') : ?>
                                <span class="new"><?php echo esc_html__('New', 'frameflow'); ?></span>
                            <?php endif; ?>
                        </div>
                    <?php endif; ?>
                </div>
            ...
            <div class="wrap-button">
                <?php if (!empty($settings['btn_text'])) : ?>
                    <div class="pxl-item--readmore ">
                        <a class="btn" <?php pxl_print_html($widget->get_render_attribute_string('button')); ?>>
                ...
                <?php if (!empty($settings['btn_text2'])) : ?>
                    <div class="pxl-item--readmore ">
                        <a class="btn" <?php pxl_print_html($widget->get_render_attribute_string('button2')); ?>>
